...
var format_gpstracks1411_7 = new ol.format.GeoJSON();
var features_gpstracks1411_7 = format_gpstracks1411_7.readFeatures(json_gpstracks1411_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3067'});
var jsonSource_gpstracks1411_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_gpstracks1411_7.addFeatures(features_gpstracks1411_7);
var lyr_gpstracks1411_7 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_gpstracks1411_7, 
                style: style_gpstracks1411_7,
                interactive: true,
                title: '<img src="styles/legend/gpstracks1411_7.png" /> gps tracks 14.11'
            });

lyr_CartoPositron_0.setVisible(true);lyr_GoogleMaps_1.setVisible(false);lyr_GoogleSatellite_2.setVisible(false);lyr_OpenStreetMap_3.setVisible(false);lyr_helsinkiborder_4.setVisible(true);lyr_missedstreets_5.setVisible(true);lyr_routes3110_6.setVisible(true);lyr_gpstracks1411_7.setVisible(true);
var layersList = [lyr_CartoPositron_0,lyr_GoogleMaps_1,lyr_GoogleSatellite_2,lyr_OpenStreetMap_3,lyr_helsinkiborder_4,lyr_missedstreets_5,lyr_routes3110_6,lyr_gpstracks1411_7];
...
lyr_gpstracks1411_7.set('fieldAliases', {'fid': 'fid', 'Area': 'Area', 'Distance': 'Distance', 'Date': 'Date', 'Time': 'Time', 'Pace': 'Pace', 'Elevation': 'Elevation', 'Link': 'Link', 'Streets': 'Streets', 'Run': 'Run', });
...
lyr_gpstracks1411_7.set('fieldImages', {'fid': 'Hidden', 'Area': 'TextEdit', 'Distance': 'TextEdit', 'Date': 'DateTime', 'Time': 'TextEdit', 'Pace': 'TextEdit', 'Elevation': 'TextEdit', 'Link': 'TextEdit', 'Streets': 'Range', 'Run': 'Range', });
...
lyr_gpstracks1411_7.set('fieldLabels', {'Area': 'inline label', 'Distance': 'inline label', 'Date': 'inline label', 'Time': 'inline label', 'Pace': 'inline label', 'Elevation': 'inline label', 'Link': 'inline label', 'Streets': 'inline label', 'Run': 'inline label', });
lyr_gpstracks1411_7.on('precompose', function(evt) {
