...
ol.proj.get("EPSG:3067").setExtent([378282.001164, 6667566.825318, 406619.090196, 6685756.308511]);
var wms_layers = [];
...
var format_gpstracks298_3 = new ol.format.GeoJSON();
var features_gpstracks298_3 = format_gpstracks298_3.readFeatures(json_gpstracks298_3, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3067'});
var jsonSource_gpstracks298_3 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_gpstracks298_3.addFeatures(features_gpstracks298_3);
var lyr_gpstracks298_3 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_gpstracks298_3, 
                style: style_gpstracks298_3,
                interactive: true,
                title: '<img src="styles/legend/gpstracks298_3.png" /> gps tracks 29.8'
            });

lyr_CartoPositron_0.setVisible(true);lyr_helsinkiborder_1.setVisible(true);lyr_missedstreets_2.setVisible(true);lyr_gpstracks298_3.setVisible(true);
var layersList = [lyr_CartoPositron_0,lyr_helsinkiborder_1,lyr_missedstreets_2,lyr_gpstracks298_3];
lyr_helsinkiborder_1.set('fieldAliases', {'fid': 'fid', });
lyr_missedstreets_2.set('fieldAliases', {'fid': 'fid', 'Street': 'Street', 'Area': 'Area', });
lyr_gpstracks298_3.set('fieldAliases', {'fid': 'fid', 'Area': 'Area', 'Distance': 'Distance', 'Date': 'Date', 'Time': 'Time', 'Pace': 'Pace', 'Elevation': 'Elevation', 'Link': 'Link', 'Streets': 'Streets', 'run': 'run', });
...
lyr_gpstracks298_3.set('fieldImages', {'fid': '', 'Area': '', 'Distance': '', 'Date': '', 'Time': '', 'Pace': '', 'Elevation': '', 'Link': '', 'Streets': '', 'run': '', });
lyr_helsinkiborder_1.set('fieldLabels', {});
lyr_missedstreets_2.set('fieldLabels', {'Street': 'inline label', 'Area': 'inline label', });
lyr_gpstracks298_3.set('fieldLabels', {'fid': 'no label', 'Area': 'inline label', 'Distance': 'inline label', 'Date': 'inline label', 'Time': 'inline label', 'Pace': 'inline label', 'Elevation': 'inline label', 'Link': 'inline label', 'Streets': 'inline label', 'run': 'inline label', });
lyr_gpstracks298_3.on('precompose', function(evt) {
