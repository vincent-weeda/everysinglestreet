...
function exp_routes3110_6rule2_eval_expression(context) {
    // Status = 'adjust'
...
function exp_routes3110_6rule3_eval_expression(context) {
    // Status = 'next'
...
function exp_routes3110_6rule4_eval_expression(context) {
    // Status = 'optional'
