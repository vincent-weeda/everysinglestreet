...
ol.proj.get("EPSG:3067").setExtent([380524.428540, 6669458.392811, 398268.209281, 6683544.940142]);
var wms_layers = [];
...
lyr_everysinglestreet_routes_1.set('fieldImages', {'fid': 'Hidden', 'Name': 'TextEdit', 'Length': 'TextEdit', 'Done': 'CheckBox', });
...
lyr_everysinglestreet_routes_1.set('fieldLabels', {'Name': 'header label', 'Length': 'header label', 'Done': 'header label', });
