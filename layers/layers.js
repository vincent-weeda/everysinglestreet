...
lyr_photos_5.set('fieldImages', {'fid': 'Hidden', 'photo': 'ExternalResource', 'filename': 'ExternalResource', 'directory': 'ExternalResource', 'altitude': 'Hidden', 'direction': 'Hidden', 'longitude': 'Hidden', 'latitude': 'Hidden', 'timestamp': 'Hidden', 'imgsrc': 'TextEdit', });
...
lyr_photos_5.set('fieldLabels', {'photo': 'header label', 'filename': 'header label', 'directory': 'header label', 'imgsrc': 'header label', });
