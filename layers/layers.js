...
ol.proj.get("EPSG:3067").setExtent([379310.705833, 6668424.134305, 404242.418033, 6686482.242982]);
var wms_layers = [];
...
var format_gpstracks_1 = new ol.format.GeoJSON();
var features_gpstracks_1 = format_gpstracks_1.readFeatures(json_gpstracks_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3067'});
var jsonSource_gpstracks_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_gpstracks_1.addFeatures(features_gpstracks_1);
var lyr_gpstracks_1 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_gpstracks_1, 
                style: style_gpstracks_1,
                interactive: true,
                title: '<img src="styles/legend/gpstracks_1.png" /> gps tracks'
            });
...
lyr_basemap_0.setVisible(true);lyr_gpstracks_1.setVisible(true);lyr_helsinkiborder_2.setVisible(true);lyr_missedstreets_3.setVisible(true);lyr_photos_4.setVisible(true);
var layersList = [lyr_basemap_0,lyr_gpstracks_1,lyr_helsinkiborder_2,lyr_missedstreets_3,lyr_photos_4];
lyr_gpstracks_1.set('fieldAliases', {'fid': 'fid', 'Area': 'Area', 'Distance': 'Distance', 'Date': 'Date', 'Time': 'Time', 'Pace': 'Pace', 'Elevation': 'Elevation', 'Link': 'Link', });
lyr_helsinkiborder_2.set('fieldAliases', {'fid': 'fid', });
lyr_missedstreets_3.set('fieldAliases', {'fid': 'fid', 'Street': 'Street', 'Area': 'Area', });
lyr_photos_4.set('fieldAliases', {'fid': 'fid', 'Date': 'Date', 'photo_html': 'photo_html', });
lyr_gpstracks_1.set('fieldImages', {'fid': 'Hidden', 'Area': 'TextEdit', 'Distance': 'TextEdit', 'Date': 'DateTime', 'Time': 'TextEdit', 'Pace': 'TextEdit', 'Elevation': 'TextEdit', 'Link': 'TextEdit', });
...
lyr_photos_4.set('fieldImages', {'fid': 'Hidden', 'Date': 'DateTime', 'photo_html': 'TextEdit', });
lyr_gpstracks_1.set('fieldLabels', {'Area': 'inline label', 'Distance': 'inline label', 'Date': 'inline label', 'Time': 'inline label', 'Pace': 'inline label', 'Elevation': 'inline label', 'Link': 'inline label', });
