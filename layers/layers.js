...
ol.proj.get("EPSG:3067").setExtent([376975.408052, 6668075.880968, 407817.457017, 6693197.227302]);
var wms_layers = [];
...
var format_gps_tracks_20210204_4 = new ol.format.GeoJSON();
var features_gps_tracks_20210204_4 = format_gps_tracks_20210204_4.readFeatures(json_gps_tracks_20210204_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3067'});
var jsonSource_gps_tracks_20210204_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_gps_tracks_20210204_4.addFeatures(features_gps_tracks_20210204_4);
var lyr_gps_tracks_20210204_4 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_gps_tracks_20210204_4, 
                style: style_gps_tracks_20210204_4,
                interactive: true,
                title: '<img src="styles/legend/gps_tracks_20210204_4.png" /> gps_tracks_20210204'
            });
...
lyr_basemap_0.setVisible(true);lyr_routes_1.setVisible(true);lyr_missedstreets_2.setVisible(true);lyr_helsinkiborder_3.setVisible(true);lyr_gps_tracks_20210204_4.setVisible(true);lyr_photos_5.setVisible(true);
var layersList = [lyr_basemap_0,lyr_routes_1,lyr_missedstreets_2,lyr_helsinkiborder_3,lyr_gps_tracks_20210204_4,lyr_photos_5];
...
lyr_gps_tracks_20210204_4.set('fieldAliases', {'fid': 'fid', 'name': 'name', 'Area': 'Area', 'Distance': 'Distance', 'Date': 'Date', 'Time': 'Time', 'Pace': 'Pace', 'Elevation_number': 'Elevation_number', 'Elevation': 'Elevation', 'Link': 'Link', 'layer': 'layer', 'path': 'path', });
...
lyr_gps_tracks_20210204_4.set('fieldImages', {'fid': 'Hidden', 'name': 'Hidden', 'Area': 'TextEdit', 'Distance': 'TextEdit', 'Date': 'DateTime', 'Time': 'TextEdit', 'Pace': 'TextEdit', 'Elevation_number': 'Hidden', 'Elevation': 'TextEdit', 'Link': 'TextEdit', 'layer': 'Hidden', 'path': 'Hidden', });
lyr_photos_5.set('fieldImages', {'fid': 'Hidden', 'altitude': 'Hidden', 'direction': 'Hidden', 'longitude': 'Hidden', 'latitude': 'Hidden', 'timestamp': 'Hidden', 'Date': 'DateTime', 'photo_html': '', });
...
lyr_gps_tracks_20210204_4.set('fieldLabels', {'Area': 'inline label', 'Distance': 'inline label', 'Date': 'inline label', 'Time': 'inline label', 'Pace': 'inline label', 'Elevation': 'inline label', 'Link': 'inline label', });
