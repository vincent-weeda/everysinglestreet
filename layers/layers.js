...
ol.proj.get("EPSG:3067").setExtent([379768.578750, 6669526.340325, 403510.523219, 6685560.090341]);
var wms_layers = [];
...
lyr_basemap_0.setVisible(true);lyr_helsinkiborder_1.setVisible(true);lyr_routes_2.setVisible(true);lyr_gpstracks_3.setVisible(true);lyr_missedstreets_4.setVisible(true);lyr_photos_5.setVisible(true);
var layersList = [lyr_basemap_0,lyr_helsinkiborder_1,lyr_routes_2,lyr_gpstracks_3,lyr_missedstreets_4,lyr_photos_5];
