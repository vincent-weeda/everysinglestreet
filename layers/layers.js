...
ol.proj.get("EPSG:3067").setExtent([378274.636140, 6668494.698608, 404918.109379, 6686095.655856]);
var wms_layers = [];
...
lyr_missedstreets_3.set('fieldImages', {'fid': '', });
...
lyr_missedstreets_3.set('fieldLabels', {'fid': 'no label', });
