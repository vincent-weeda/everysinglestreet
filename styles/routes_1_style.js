...
var style_routes_1 = function(feature, resolution){
    ...
    if ("" !== null) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(129,129,129,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 1}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                      ...
                      return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(129,129,129,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
